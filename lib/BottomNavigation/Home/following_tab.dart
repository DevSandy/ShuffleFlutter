...
class FollowingTabPage extends StatefulWidget {
  ...
  @override
  State<FollowingTabPage> createState() => _FollowingTabPageState();
}

class _FollowingTabPageState extends State<FollowingTabPage> {
  @override
  Widget build(BuildContext context) {
    return FollowingTabBody(widget.videos, widget.images, widget.isFollowing, widget.variable);
  }
}
